...
def basic(dataframe, rango, file_name=None, function_name=None, recover=None, omega=None, tol=1e-8, maxiter=100, init='random',
          printitn=0):
    """
...
#             print("Select PARAFAC as cp_als")
            [Final, Rec, Rec_hat, mask] = pyten.method.cp_als(X, rango, omega, tol, maxiter, init, printitn)
            full = Final.totensor()
...
#         print Rec.data
    ...
    # Return result
    return Ori, full, Final, Rec, Rec_hat, mask
